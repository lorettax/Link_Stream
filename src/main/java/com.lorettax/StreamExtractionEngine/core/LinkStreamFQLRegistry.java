...
import com.lorettax.StreamExtractionEngine.core.functions.*;
...
public class LinkStreamFQLRegistry {

    private static final Logger logger = LoggerFactory.getLogger(LinkStreamFQLRegistry.class);
    ...
    private static final Map<String, AbstractFunction> FUNCTION_MAP = ImmutableMap.copyOf(
            FUNCTION_SET.stream().map(e -> new ImmutablePair<>(e.getOp(), e))
