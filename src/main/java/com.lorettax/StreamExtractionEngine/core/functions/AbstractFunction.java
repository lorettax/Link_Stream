...
import com.lorettax.StreamExtractionEngine.core.*;
import com.lorettax.StreamExtractionEngine.ignite.ApacheIgniteManager;
...
public abstract class AbstractFunction {
    ...
    protected abstract Map<String, Object> doExecute(LinkStreamFQL fql,
                                                     JSONObject event,
                                                     Map<String, Object> helper,
                                                     String mode) throws Exception;

    protected Map<String, Object> defaultValue(LinkStreamFQL fql,
                                               JSONObject event,
                                               Map<String, Object> helper,
                                               String mode) throws Exception {
    ...
    public Map<String, Object> execute(LinkStreamFQL fql,
                                       JSONObject event,
                                       Map<String, Object> helper,
                                       String mode) throws Exception {
    ...
    protected String genSpace(LinkStreamFQL fql, JSONObject event) {
    ...
    protected String genSubspace(LinkStreamFQL fql, JSONObject event) {
    ...
    protected String genCacheName(LinkStreamFQL fql, JSONObject event) {
    ...
    protected boolean isUpdateMode(String mode) {
        return LinkStreamFQLMode.UPDATE.equalsIgnoreCase(mode) || LinkStreamFQLMode.UPGET.equalsIgnoreCase(mode);
    }

    protected boolean matchEventType(LinkStreamFQL fql, JSONObject event) {
    ...
    protected boolean isGetMode(String mode) {
        return LinkStreamFQLMode.GET.equalsIgnoreCase(mode) || LinkStreamFQLMode.UPGET.equalsIgnoreCase(mode);
    }
    ...
    protected SortedMap<String, Field> sortedOn(LinkStreamFQL fql) {
        final SortedMap<String, Field> onFields = Maps.newTreeMap();
        if (fql.getOn() != null) {
